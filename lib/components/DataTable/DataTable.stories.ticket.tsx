...
const TicketCellTitle = ({
  ...
  return (
    <div className="flex min-w-0 max-w-[400px] gap-2 whitespace-nowrap p-3">
      ...
      <span
        className="flex-auto truncate whitespace-nowrap text-meteor-300"
...
const TicketCellDate = ({ dateString }: { dateString: string | null }) => {
  if (!dateString) return <div className="p-3">--</div>

  const date = new Date(dateString)

  return <div className="p-3">Apr {date.getDate()}</div>
}
