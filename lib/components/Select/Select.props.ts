...
type SelectSizeOptions = 'small' | 'medium'
export const SelectSizes = {
  Small: 'small',
  Medium: 'medium',
} as { [key: string]: SelectSizeOptions }

type SelectTypeOptions = 'standard' | 'shadow'
export const SelectTypes = {
  Standard: 'standard',
  Shadow: 'shadow',
} as { [key: string]: SelectTypeOptions }

export enum SelectItemRenderingContext {
  SelectedSingle = '0',
  SelectedMultiple = '1',
  SelectedChip = '2',
  Flyout = '3',
...
export type DecoratorsGenerator = (
  item: SelectItemType,
  context: SelectItemRenderingContext,
) => {
