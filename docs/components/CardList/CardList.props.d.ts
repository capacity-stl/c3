...
declare const cardlistVariants: (props?: ({} & import('class-variance-authority/types').ClassProp) | undefined) => string;
export type CardListProps<T> = VariantProps<typeof cardlistVariants> & React.ComponentProps<'ul'> & {
