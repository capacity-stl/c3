...
export interface ModalRootProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof modalVariants> {
    className?: string;
...
export interface ModalHeaderProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof modalVariants> {
    className?: string;
    children?: React.ReactNode;
    title?: string;
    description?: string;
...
export interface ModalBodyProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof modalVariants> {
    className?: string;
    children?: React.ReactNode;
    testId?: string;
}
export interface ModalFooterProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof modalVariants> {
    className?: string;
    children?: React.ReactNode;
    testId?: string;
    showBorder?: boolean;
...
export interface ModalConfirmationProps extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof modalVariants> {
    className?: string;
    title?: string;
    description?: string;
    onConfirm?: () => void;
